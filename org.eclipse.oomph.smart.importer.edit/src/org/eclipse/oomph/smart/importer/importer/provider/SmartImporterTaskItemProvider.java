...
/**
 * This is the item provider adapter for a {@link org.eclipse.oomph.smart.importer.importer.SmartImporterTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SmartImporterTaskItemProvider extends SetupTaskItemProvider
{
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(ImporterPackage.Literals.SMART_IMPORTER_TASK__SOURCE_LOCATORS);
    }
  ...
  public String getText(Object object)
  {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_SmartImporterTask_type") :
      getString("_UI_SmartImporterTask_type") + " " + label;
  }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (ImporterPackage.Literals.SMART_IMPORTER_TASK__SOURCE_LOCATORS,
  ...
  {
    return SmartImporterEditPlugin.INSTANCE;
  }
